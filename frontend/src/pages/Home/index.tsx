          ...
          <div className="flex flex-row">
            <form
              onSubmit={(e) => {
                ...
                let a: WebSocket;
                try {
                  a = new WebSocket(`wss://${window.location.href.substring(7, 16)}:9999`, [room, nick]);
                } catch (e) {
  ...
  //+------------------------------------------------------------------+
    ...
    return (
      <UserContext.Provider value={socket}>
        <LinePage room={room} timer={timer} UserContext={UserContext} nick={nick} players={players} chatMessages={chatMessages}></LinePage>
